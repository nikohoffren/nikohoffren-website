              ...
              <p className="text-md text-gray-800 dark:text-white py-2">
                {language === "en" ? (
                  <>
                    ...
                    checkout functionality powered by Stripe. Tools: React,
                    Vite, TypeScript, Tailwind CSS, Netlify Functions, Firebase
                    and Stripe.{" "}
                  </>
                ) : (
                  <>
            ...
            <div className="bg-white dark:bg-gray-800 w-full p-4">
              ...
              <p className="text-md text-gray-800 dark:text-white py-2">
                {language === "en" ? (
                  <>
                    {" "}
                    Welcome to Fork, Commit, Merge! Your one-stop resource hub
                    for mastering GitHub contributions! Whether you're a novice
                    coder or an experienced developer, our comprehensive guides
                    are designed to streamline your GitHub journey. Tools:
                    React, NextJS, TypeScript, Tailwind CSS, MongoDB and AWS S3.{" "}
                  </>
                ) : (
                  <>
                    {" "}
                    ...
                    Työkalut: React, NextJS, TypeScript, Tailwind CSS, MongoDB
                    ja AWS S3.{" "}
                  </>
                )}
              </p>
              ...
              <p className="text-md text-gray-800 dark:text-white py-2">
                {language === "en" ? (
                  <>
                    ...
                    open source contribution workflow on GitHub! We present
                    tasks of varying difficulty. You're free to choose either
                    the easy or medium issue, depending on your proficiency in
                    HTML or JavaScript Tools: JavaScript, Node.js.{" "}
                  </>
                ) : (
                  <>
            ...
            <div className="bg-white dark:bg-gray-800 w-full p-4">
              ...
              <p className="text-md text-gray-800 dark:text-white py-2">
                {language === "en" ? (
                  <>
                    {" "}
                    This Flutter application is built to help people keep track
                    of their valuable devices and protect them from theft. It
                    allows users to register their devices, such as computers,
                    cars, musical instruments, and more.
                    <br />
                  ...
                  <>
                    {" "}
                    Tämä Flutter-sovellus on rakennettu auttamaan ihmisiä
                    pitämään kirjaa arvokkaista laitteistaan ja suojaamaan niitä
                    varkauksilta.
                    <br />
                    <br />
              ...
              <p className="text-md text-gray-800 dark:text-white py-2">
                {language === "en" ? (
                  <>
                    ...
                    CSS framework designed for ease of use. It provides a
                    collection of reusable CSS classes and components to quickly
                    style your web projects. Published as npm-package. The
                    website and detailed documentation are still in the
                    production phase. Tools: CSS, JavaScript & Node.js.{" "}
                  </>
                ) : (
                  <>
              ...
              <p className="text-md text-gray-800 dark:text-white py-2">
                {language === "en" ? (
                  <>
                    ...
                    <br />
                    <br />
                    Built with React and Vite, and uses the Fabric.js library
            ...
            <div className="bg-white dark:bg-gray-800 w-full p-4">
              ...
              <p className="text-md text-gray-800 dark:text-white py-2">
                {language === "en" ? (
                  ...
                  <>
                    Smart Meeting Scheduler Chrome -laajennus on tehokas
                    työkalu, joka on suunniteltu helpottamaan ja tehostamaan
                    kokousten ajanvaraamisprosessia käyttäen Google-kalenteria.
                    <br />
                    <br />
